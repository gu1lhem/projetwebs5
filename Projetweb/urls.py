...
urlpatterns = [
   ...
   path('UC/<str:CodeMatiere>/', UCDetail.as_view(), name='uc-detail'),
   path('UC/<str:CodeMatiere>/update/', UCUpdate.as_view(), name='uc-update'),
   path('UC/<str:CodeMatiere>/delete/', UCDelete.as_view(), name='uc-delete'),
