...
urlpatterns = [
   ...
   path('professeur/add',ProfesseurCreate.as_view(),name='professeur-update'),
   path('professeur/<int:NumProfesseur>/',ProfesseurDetail.as_view(),name='professeur-delete'),
   ...
   path('UE/<str:NomMatiere>/', UEDetail.as_view(), name='ue-detail'),
   path('UE/<str:NomMatiere>/update/', UEUpdate.as_view(), name='ue-update'),
   path('UE/<str:NomMatiere>/delete/', UEDelete.as_view(), name='ue-delete'),
   ...
   path('semestre/<int:NumSemestre>/', SemestreDetail.as_view(), name='semestre-detail'),
   path('semestre/<int:NumSemestre>/update/', SemestreUpdate.as_view(), name='semestre-update'),
   path('semestre/<int:NumSemestre>/delete/', SemestreDelete.as_view(), name='semestre-delete'),
]
